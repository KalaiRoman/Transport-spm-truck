        ...
        <div className="col-xl-8 col-lg-7">
          <div className="blog-details__left">
            ...
            <div className="blog-details__content">
              ...
              <h3 className="blog-details__title">Future Is Bright When You Are More Prepared</h3>
            ...
            <div className="blog-details__bottom">
              <p className="blog-details__tags"> <span>Tags</span> <Link href="news-details">Logistics</Link> <Link href="news-details">Retail</Link> </p>
            ...
            <div className="comment-one">
              ...
              <div className="comment-one__single">
                <div className="comment-one__image"> <img src="/images/resource/testi-thumb-1.jpg" alt=""/> </div>
              ...
              <div className="comment-one__single">
                <div className="comment-one__image"> <img src="/images/resource/testi-thumb-2.jpg" alt=""/> </div>
                <div className="comment-one__content">
                  <h3>Sarah Albert</h3>
                  <p>Mauris non dignissim purus, ac commodo diam. Donec sit amet lacinia nulla. Aliquam quis purus in justo pulvinar tempor. Aliquam tellus nulla, sollicitudin at euismod. </p>
                  <Link href="news-details" className="theme-btn btn-style-one comment-one__btn"><span className="btn-title">Reply</span></Link>
          ...
          <div className="sidebar">
              ...
              <ul className="sidebar__post-list list-unstyled">
                <li>
                  ...
                  <div className="sidebar__post-content">
                    <h3>
                      <span className="sidebar__post-content-meta"><i className="fas fa-user-circle"></i>Admin</span>
                      <Link href="news-details">Will Supply Chains Become Supply</Link>
                    </h3>
                  </div>
                </li>
                <li>
                  ...
                  <div className="sidebar__post-content">
                    <h3>
                      <span className="sidebar__post-content-meta"><i className="fas fa-user-circle"></i>Admin</span>
                      <Link href="news-details">What’s Next In Freight & LTL Shipping</Link>
                    </h3>
                  </div>
                </li>
                <li>
                  ...
                  <div className="sidebar__post-content">
                    <h3>
                      <span className="sidebar__post-content-meta"><i className="fas fa-user-circle"></i>Admin</span>
                      <Link href="news-details">Bring to the table win survival variations</Link>
                    </h3>
                  </div>
                </li>
              </ul>
            ...
            <div className="sidebar__single sidebar__category">
              ...
              <ul className="sidebar__category-list list-unstyled">
                <li>
                  <Link href="news-details">Logistics<span className="icon-right-arrow"></span></Link> </li>
                <li className="active"><Link href="news-details">Ocean<span   className="icon-right-arrow"></span></Link></li>
                <li>
                  <Link href="news-details">Packaging<span className="icon-right-arrow"></span></Link> </li>
                <li>
                  <Link href="news-details">Production<span className="icon-right-arrow"></span></Link> </li>
                <li>
                  <Link href="news-details">Technology<span className="icon-right-arrow"></span></Link> </li>
                <li>
                  <Link href="news-details">Warehouses<span className="icon-right-arrow"></span></Link> </li>
              </ul>
            </div>
            <div className="sidebar__single sidebar__tags">
              <h3 className="sidebar__title">Tags</h3>
              <div className="sidebar__tags-list"> <Link href="#">Cargo</Link> <Link href="#">Freight</Link> <Link href="#">Logistics</Link> <Link href="#">Retail</Link> <Link href="#">Startegy</Link> <Link href="#">Transport</Link> </div>
            </div>
              ...
              <ul className="sidebar__comments-list list-unstyled">
                <li>
                  ...
                  <div className="sidebar__comments-text-box">
                    <p>A wordpress commenter on <br/> launch new mobile app
                    </p>
                  </div>
                </li>
                <li>
