          ...
          <div className="col-xl-6 col-lg-6">
            <div className="team-details__top-left">
              <div className="team-details__top-img">
                ...
                <div className="team-details__big-text">Aleesha</div>
              </div>
            </div>
          </div>
          <div className="col-xl-6 col-lg-6">
          ...
          <div className="col-xl-6 col-lg-6">
            <div className="team-details__bottom-right">
              <div className="team-details__progress">
                ...
                <div className="team-details__progress-single">
                  <h4 className="team-details__progress-title">Analytical ability</h4>
                  <div className="bar">
  ...
  <section className="team-contact-form">
    <div className="container pb-100">
      <div className="sec-title text-center">
        ...
        <h2 className="section-title__title">Feel Free to Write Our <br/> Service Experts</h2>
      </div>
