        ...
        <div className="row">
          ...
          <div className="footer-column col-xl-4 col-lg-12 col-md-6 col-sm-12">
            <div className="footer-widget about-widget">
              ...
              <div className="text">Desires to obtain pain of itself, because it is pain, but occasionally
              circumstances.</div>

              <div className="subscribe-form">
                <form method="post" action="#">
                  <div className="form-group">
                    <input type="email" name="email" className="email" value="" placeholder="Email Address"
                    required=""/>
                    <button type="button" className="theme-btn btn-style-one"><span className="btn-title">GO</span></button>
                  </div>
                </form>
              </div>
          ...
          <div className="footer-column col-xl-3 col-lg-5 col-md-6 col-sm-12">
            <div className="footer-widget recent-posts">
              ...
              <div className="widget-content">
                <div className="post">
                  <div className="thumb"><Link href="#"><img src="/images/resource/post-thumb-1.jpg" alt=""/></Link>
                  </div>
                ...
                <div className="post">
                  <div className="thumb"><Link href="#"><img src="/images/resource/post-thumb-2.jpg" alt=""/></Link>
                  </div>
                  <span className="date">20 Jul, 2022</span>
                  <h4><Link href="#">Logixs name a finalist consumer choice award</Link></h4>
                </div>
