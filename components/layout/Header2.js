            ...
            <header className={`main-header header-style-two ${isSearch ? "moblie-search-active" : ""}`}>
                ...
                <div className="auto-container">
                    ...
                    <div className="top-left"> 
                        ...
                        <li><i className="fa fa-phone-volume"></i> <Link href="tel:+9288007860"> +92(8800)7860</Link></li>
                ...
                <div className="auto-container"> 
                    ...
                    <div className="logo"><Link href="/"><img src="/images/logo-2.png" alt="" title="logixs"/></Link></div>
